...
import { addNotifyApi, delNotifyApi, putNotifyApi } from '~/redux/slices/Data/notificationSlice';
...
const Notification = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            optionSelect: [{ label: 'Public', value: 'Public' }, { label: 'Private', value: 'Private' }],
            ...FilterSelect('type', [{ value: 'Public', text: 'Public' }, { value: 'Private', text: 'Private' }])
        },
        {
            title: 'Ẩn/Hiện',
            dataIndex: 'show',
            ...
            optionSelect: [{ label: 'Hiển thị', value: true }, { label: 'Ẩn', value: false }],
            ...FilterSelect('type', [{ value: true, text: 'Hiển thị' }, { value: false, text: 'Ẩn' }])
        },
        {
            title: 'Ngày tạo',
            dataIndex: 'createdAt',
    ...
    return (
        <LayoutAdmin
            header='Thông báo'
            button={
                <Button type='primary' onClick={() => setOpenAdd(true)}>Thêm thông báo</Button>
            }
        >
            <Table
                dragMode={false}
