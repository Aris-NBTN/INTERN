...
import { Button, Card, Drawer, Empty, Skeleton, Typography, Tooltip } from 'antd';
                    ...
                    {isPurchased || info.price === 0 ? (
                      user?.userType ? (
                        ...
                        <Tooltip placement="right" title={'Đăng nhập để học'}>
                          <div className="iconBox" onClick={() => navigate("/login", { state: { from: `/user/course/${info.slug}` } })}>
            ...
            <div className="content h-full">
              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                {isPurchased && info.price > 0 ? (
                  ...
                  info.price === 0 ? (
                    <Typography.Title className='!mb-0' level={3} type='success'>Miễn phí</Typography.Title>
                  ) : (
